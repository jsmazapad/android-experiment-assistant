...
public class GameRotationVector extends MySensor implements SensorEventListener {
    ...
    public GameRotationVector() {
        super(SensorConfigConstants.TYPE_GAME_ROTATION_VECTOR, R.string.game_rotation_vector, FrequencyConstants.MIN_SENSOR_INTERVAL_MILLIS);
            ...
            public void run() {
                if (GameRotationVector.this.isRecording) {
                    ...
                    if (BuildConfig.DEBUG)
                        Log.d("Sensor", App.getAppContext().getString(GameRotationVector.this.getNameStringResource()) + ": " + values.toString() );
