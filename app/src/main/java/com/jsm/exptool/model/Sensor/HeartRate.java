...
public class HeartRate extends MySensor implements SensorEventListener {
    ...
    public HeartRate() {
        super(SensorConfigConstants.TYPE_HEART_RATE, R.string.heart_rate,  SensorConfigConstants.MIN_INTERVAL_MILLIS);
            ...
            public void run() {
                if (HeartRate.this.isRecording) {
                    ...
                    if (BuildConfig.DEBUG)
                        Log.d("Sensor", App.getAppContext().getString(HeartRate.this.getRName()) + ": " + values.toString() );
