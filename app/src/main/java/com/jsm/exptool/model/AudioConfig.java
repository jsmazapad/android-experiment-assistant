...
public class AudioConfig implements Repeatable{
    ...
    public AudioConfig(int rName, int interval, int intervalMin, CameraProvider.FlashModes flashMode, CameraProvider.CameraPositions cameraPosition) {
        this.rName = rName;
