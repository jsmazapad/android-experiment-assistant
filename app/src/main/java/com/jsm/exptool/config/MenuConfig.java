...
public class MenuConfig {
    ...
    public static List<MenuElement> menuElements = Arrays.asList(
            new MenuElement(R.string.title_experiments_fragment, "", R.color.white, MenuElement.ElementGravity.RIGHT, R.drawable.flask_color, R.drawable.flask_color, R.id.nav_experiments, true, false, null),
            new MenuElement(R.string.title_experiments_create_fragment, "", R.color.white, MenuElement.ElementGravity.RIGHT, R.drawable.ic_baseline_create_new_folder_24, R.drawable.ic_baseline_create_new_folder_24, R.id.nav_experiment_create, true, false, null),
