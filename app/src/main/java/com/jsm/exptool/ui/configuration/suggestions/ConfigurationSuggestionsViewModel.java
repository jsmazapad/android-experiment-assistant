...
public class ConfigurationSuggestionsViewModel extends BaseRecyclerViewModelListener<CommentSuggestion, CommentSuggestion> implements DeleteActionListener<CommentSuggestion> {
