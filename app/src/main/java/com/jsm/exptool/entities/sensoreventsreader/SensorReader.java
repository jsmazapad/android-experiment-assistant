...
public class SensorReader implements SensorEventListener {
    ...
    public SensorReader(int sensorType, SortedMap<String, Float> measure) {
        ...
        this.sensor = SensorProvider.getInstance().getSensorManager().getDefaultSensor(sensorType);
    ...
    public void cancelListener(){
        if (this.triggerEventInterface != null) {
            ...
            SensorProvider.getInstance().getSensorManager().unregisterListener(this);
        }
    }
